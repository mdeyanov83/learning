# FastAPI + PostgreSQL + Nginx deployment ready
...
- API service based on python-slim image
...
- Nginx container as a reverse proxy (SSL not implemented)

- Accessed at the VM/VPS IP address on default HTTP port 80
- Port 5432 open and forwarded for remote access to the database via pgAdmin
