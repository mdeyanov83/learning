...
def validate_integer(
    ...
    """Validate taht 'arg_value' is an integer, and optionally falls within specific bounds.
    ...
    Args:
        ...
        min_value (int, optional): specifies minimum value (inclusive). Defaults to None.
        max_value (int, optional): specifies maximum value (inclusive). Defaults to None.
        custom_min_message (str, optional): custom message when value is less than minimum. Defaults to None.
        custom_max_message (str, optional): custom message when value is greater than maximum. Defaults to None.
